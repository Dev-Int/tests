...
final class Version20240712210900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_23A0E664E7B3801 ON article (packaging_id)');
        ...
        $this->addSql(
            ...
            'id SERIAL NOT NULL, ' .
            'parcel_unit_id UUID DEFAULT NULL, ' .
        ...
        $this->addSql(
            'ALTER TABLE article ADD CONSTRAINT FK_23A0E664E7B3801 FOREIGN KEY (packaging_id) ' .
            'REFERENCES packaging (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
        $this->addSql(
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP CONSTRAINT FK_23A0E664E7B3801');
