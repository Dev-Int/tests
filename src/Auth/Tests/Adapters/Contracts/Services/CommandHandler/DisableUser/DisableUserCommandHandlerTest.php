...
namespace Auth\Tests\Adapters\Contracts\Services\CommandHandler\DisableUser;

use Auth\Adapters\ContractsHandler\Services\CommandHandler\DisableUser\DisableUserCommandHandler;
 ...
 *
 * @covers \Auth\Adapters\ContractsHandler\Services\CommandHandler\DisableUser\DisableUserCommandHandler
 * @covers \Auth\Adapters\ContractsHandler\Services\CommandHandler\DisableUser\InternalDisableUserRequest
 */
final class DisableUserCommandHandlerTest extends BaseFunctionalTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->userDisabler = new DisableUserCommandHandler($disableUserUseCase);
