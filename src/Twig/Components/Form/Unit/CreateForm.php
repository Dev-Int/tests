...
namespace App\Twig\Components\Form\Unit;
...
final class CreateForm extends AbstractController
{
    ...
    #[LiveProp]
    public CreateUnitApiRequest $initialFormData;

    protected function instantiateForm(): FormInterface
    {
        return $this->createForm(ChangeLabelUnitType::class, $this->initialFormData);
    }
}
