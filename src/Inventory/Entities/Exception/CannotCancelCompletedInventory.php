...
final class CannotCancelCompletedInventory extends DomainException implements \JsonSerializable
{
    public const string MESSAGE = 'Impossible d\'annuler un inventaire finalisé.';
