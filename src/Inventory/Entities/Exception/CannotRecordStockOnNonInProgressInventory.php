...
final class CannotRecordStockOnNonInProgressInventory extends DomainException implements \JsonSerializable
{
    public const string MESSAGE = 'Cannot record stock on inventory that is not in progress.';
