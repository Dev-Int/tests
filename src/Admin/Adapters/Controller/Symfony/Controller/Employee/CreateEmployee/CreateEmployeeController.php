    ...
    public function __invoke(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                ...
                $context = [
                    'employeeId' => $response->employee->uuid()->toString(),
                    'userId' => $response->employee->userUuid()->toString(),
                ];
                $this->logger->info('Employee created successfully', $context);
                ...
                $this->addFlash('error', $this->translator->trans('admin.employee.create.error.unknown'));
