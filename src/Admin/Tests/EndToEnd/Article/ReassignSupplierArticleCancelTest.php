 ...
 * @group e2eTest
 */
final class ReassignSupplierArticleCancelTest extends BasePantherTestCase
{
    public function testCancelDuringArticleReassignSupplier(): void
    {
        // Arrange
        ...
        $reassignSupplierButtonText = $translator->trans('admin.article.reassignSupplier.button');
        $client->clickLink($reassignSupplierButtonText);
