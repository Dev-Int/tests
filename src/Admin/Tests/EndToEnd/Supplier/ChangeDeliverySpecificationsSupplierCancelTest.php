 ...
 * @group e2eTest
 */
final class ChangeDeliverySpecificationsSupplierCancelTest extends BasePantherTestCase
{
    public function testCancelDuringSupplierChangeDeliverySpecifications(): void
    {
        // Arrange
        ...
        $changeDeliverySpecsButtonText = $translator->trans('admin.supplier.changeDeliverySpecifications.button');
        $client->clickLink($changeDeliverySpecsButtonText);
