 ...
 * @group e2eTest
 */
final class ChangeContactSupplierCancelTest extends BasePantherTestCase
{
    use AuthenticatedPantherTestTrait;

    public function testCancelDuringSupplierChangeContact(): void
    {
        // Arrange
        ...
        $changeContactButtonText = $translator->trans('admin.supplier.changeContact.button');
        $client->clickLink($changeContactButtonText);
