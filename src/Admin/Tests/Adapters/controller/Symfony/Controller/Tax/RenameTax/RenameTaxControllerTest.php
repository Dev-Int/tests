 ...
 */
class RenameTaxControllerTest extends WebTestCase
{
    ...
    public function testRenameTaxWillSucceed(): void
    {
        ...
        static::assertSame('Tax renamed', $flash);
        ...
        static::assertSame('TVA taux réduit', $taxRenamed->name()->toString());
        static::assertSame(0.2, $taxRenamed->rate());
    }
    ...
    public function testRenameTaxFailWithAlreadyExistsException(): void
    {
        ...
        static::assertSame('Tax already exists.', $flash);
        ...
        static::assertSame('TVA taux normal', $taxRenamed->name()->toString());
        static::assertSame(0.2, $taxRenamed->rate());
    }
}
